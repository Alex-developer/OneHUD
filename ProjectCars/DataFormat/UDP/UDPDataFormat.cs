...
namespace ProjectCars.DataFormat
{
    class UDPDataFormat
    {
        ...
        public static readonly int telemetrySize = Marshal.SizeOf(typeof(ProjectCars.DataFormat.UDPDataFormat.sTelemetryData));
        public static readonly int participantInfoSize = Marshal.SizeOf(typeof(ProjectCars.DataFormat.UDPDataFormat.sParticipantInfoStrings));
        public static readonly int participantInfoAdditionalSize = Marshal.SizeOf(typeof(ProjectCars.DataFormat.UDPDataFormat.sParticipantInfoStringsAdditional));

        public struct sParticipantInfoStrings
        {
            public ushort sBuildVersionNumber;	// 0
            public byte sPacketType;	// 2
            public SmString sCarName;	// 3
            public SmString sCarClassName;	// 131 
            public SmString sTrackLocation;	// 195        
            public SmString sTrackVariation;	// 259
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16)]
            public SmString[] sName;	// 323
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16)]
